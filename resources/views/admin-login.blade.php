...
<body class=" bg-gray-100 flex items-center justify-center min-h-screen">
  <div class=" bg-white p-8 rounded-2xl shadow-lg w-full max-w-sm ">
    <h2 class=" text-2xl text-center text-gray-800 font-bold mb-6">Admin login</h2> 
          @error('user')
    ...
    <form action="/admin-login" method="POST" class=" space-y-4">
        @csrf
        <div>
        <label for="" class=" text-grey-600 mb-1">Admin name</label>
        ...
        <input type="password" placeholder="Enteradmin password" name="password"
        class=" w-full px-4 border border-gray-300 rounded-xl py-2  focus:outline-none "
        >
